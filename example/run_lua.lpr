 ...
 * или строку кода.
 *
 * Windows: рядом с exe должна быть lua54.dll.
 * Linux:   liblua.so.5.4 в LD_LIBRARY_PATH или в системном пути.
 *
 * Сборка (из каталога example):
 *   Windows: fpc -Fu"../src" -Fi"../src" run_lua.lpr
 *   Linux:   fpc -Tlinux -Px86_64 -Fu"../src" -Fi"../src" run_lua.lpr
 *   Linux (fpcupdeluxe): из корня репо — ./build_run_lua.sh  или  export FPCDIR=/path/to/fpc && fpc ...
 *
